...
const Dipro = () => {
    return (
      ...
      <div className="card-body flex-col justify-center items-center">
        ...
        <Link to="https://drive.google.com/drive/folders/1oM9RoLYyslpLrk-_RiPJjXHKly6kjPwl?usp=sharing"><p className="text-cyan-400 underline-offset-1">SRS V4</p></Link>
        <Link to="https://drive.google.com/drive/folders/1oM9RoLYyslpLrk-_RiPJjXHKly6kjPwl?usp=sharing"><p className="text-cyan-400 underline-offset-1">SRS V5</p></Link>
      </div>
    </div>
    );
};
